...
class BraintreeSubscription(models.Model):
    ...
    braintreesubscriptionPayMthdResultObject = models.CharField(max_length=32768, null=True)
    braintreesubscriptionResultObject = models.CharField(max_length=65535, null=True)
    braintreesubscriptionCancelResultObject = models.CharField(max_length=65535, null=True)
