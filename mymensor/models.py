...
class Vp(models.Model):
    ...
    vpIsSharedToTwitter = models.BooleanField(default=False)
...
class Tag(models.Model):
    ...
    tagLowRed = models.FloatField(null=True, verbose_name="minimum value from which the tag will be flagged as in LOW RED state")
    tagLowYellow = models.FloatField(null=True, verbose_name="minimum value from which the tag will be flagged as in LOW YELLOW state")
    tagExpValue = models.FloatField(null=True, verbose_name="expected value for the tag")
    tagHighYellow = models.FloatField(null=True, verbose_name="maximum value from which the tag will be flagged as in HIGH YELLOW state")
    tagHighRed = models.FloatField(null=True, verbose_name="maximum value from which the tag will be flagged as in HIGH RED state")
