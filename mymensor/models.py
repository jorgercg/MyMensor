...
class Tag(models.Model):
    ...
    tagDescription = models.CharField(max_length=1024, verbose_name="tag description")
    tagNumber = models.IntegerField()
    tagIsActive = models.BooleanField(default=True, verbose_name="tag is active")
    tagListNumber = models.IntegerField(null=True)
    tagQuestion = models.CharField(max_length=1024, verbose_name="question that shall be answered when processing this tag")
    tagUnit = models.CharField(max_length=50, null=True, verbose_name="unit to be used when processing this tag")
    tagLowRed = models.FloatField(null=True, blank=True, verbose_name="minimum value from which the tag will be flagged as in LOW RED state")
    tagLowYellow = models.FloatField(null=True, blank=True, verbose_name="minimum value from which the tag will be flagged as in LOW YELLOW state")
    tagExpValue = models.FloatField(null=True, blank=True, verbose_name="expected value for the tag")
    tagHighYellow = models.FloatField(null=True, blank=True, verbose_name="maximum value from which the tag will be flagged as in HIGH YELLOW state")
    tagHighRed = models.FloatField(null=True, blank=True, verbose_name="maximum value from which the tag will be flagged as in HIGH RED state")
