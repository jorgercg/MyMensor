...
class Asset(models.Model):
    ...
    assetGeoIpResponse = models.TextField(null=True, verbose_name="Response from MaxMind Service")
    assetCountryGeoIp = models.CharField(max_length=50,null=True, verbose_name="Asset Country from GeoIp")
