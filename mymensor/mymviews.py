...
class TagStatus(BaseDatatableView):
    ...
    columns = ['id', 'mymensor_tag.tagNumber', 'tagDescription', 'vpNumber', 'vpDescription', 'valValueEvaluated', 'tagUnit', 'mediaTimeStamp', 'tagStateEvaluated', 'assetOwner_id']

    # define column names that will be used in sorting
    # order is important and should be same as order of columns
    # displayed by datatables. For non sortable columns use empty
    # value like ''
    order_columns = ['id', 'mymensor_tag.tagNumber', 'tagDescription', 'vpNumber', 'vpDescription', 'valValueEvaluated', 'tagUnit', 'mediaTimeStamp', 'tagStateEvaluated', 'assetOwner_id']
